  ...
  $(function() {
    if ($("#order-chart").length) {
      var areaData = {
        ...
        datasets: [
          {
            data: [135,110,91,101,83,80,105,105,115,74,94,117],
            borderColor: [
              '#4747A1'
            ],
            borderWidth: 2,
    ...
    if ($("#sales-chart").length) {
      ...
      var SalesChart = new Chart(SalesChartCanvas, {
        ...
        data: {
          ...
          datasets: [{
              label: '조식',
              data: [480, 230, 470, 210, 330, 110, 210, 210],
              backgroundColor: '#98BDFF'
            },
            {
              label: '중식',
              data: [400, 340, 550, 480, 170, 210, 330, 110],
              backgroundColor: '#385FAC'
            },
            {
              label: '석식',
              data: [400, 340, 550, 480, 170, 340, 550, 480],
